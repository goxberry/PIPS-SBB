// ----------------------------------------------------------------------------
/**
   File: BBSMPSPseudoCostBranchingRuleESTIMATION.hpp
...
#ifndef BBSMPSPSEUDOCOSTBRANCHINGRULEESTIMATION_H
#define BBSMPSPSEUDOCOSTBRANCHINGRULEESTIMATION_H
...
class BBSMPSPseudoCostBranchingRuleEstimation: public BBSMPSBranchingRule {

public:

   	virtual bool branch(BBSMPSNode * node, std::vector<BBSMPSNode*> &childNodes, const denseBAVector& primalSoln);
   	
   	BBSMPSPseudoCostBranchingRuleEstimation(int priority, int _reliabilityFactor, int _rootFracVals, double _rootObj);
