...
void BBSMPSParallelPseudoCostSmallestScenarioFirstBranchingRule::initializeVariable(const denseBAVector &nodeRelaxation,BAFlagVector<variableState> &warmstart, double lpRelaxationObjValue, denseBAVector &lb, denseBAVector &ub, int scen, int col){
...
bool BBSMPSParallelPseudoCostSmallestScenarioFirstBranchingRule::performRoundOfFirstStageInitializations(const denseBAVector &sol,BAFlagVector<variableState> &warmstart,denseBAVector &lb, denseBAVector &ub, double lpRelaxationObjValue){
...
bool BBSMPSParallelPseudoCostSmallestScenarioFirstBranchingRule::performRoundOfSecondStageInitializations(const denseBAVector &sol,BAFlagVector<variableState> &warmstart,denseBAVector &lb, denseBAVector &ub, double lpRelaxationObjValue, int scen){
...
BBSMPSParallelPseudoCostSmallestScenarioFirstBranchingRule::BBSMPSParallelPseudoCostSmallestScenarioFirstBranchingRule(int priority): BBSMPSBranchingRule(priority){
...
int BBSMPSParallelPseudoCostSmallestScenarioFirstBranchingRule::getFirstStageMinIntInfeasCol( const denseBAVector& primalSoln,  SMPSInput& input) {
int col;
...
int BBSMPSParallelPseudoCostSmallestScenarioFirstBranchingRule::getFirstStageMaxFracPartCol( const denseBAVector& primalSoln,  SMPSInput& input){
int col;
...
int BBSMPSParallelPseudoCostSmallestScenarioFirstBranchingRule::isFirstStageIntFeas( const denseBAVector& primalSoln,  SMPSInput& input) {
return (getFirstStageMinIntInfeasCol(primalSoln,input) == -1);
}


void BBSMPSParallelPseudoCostSmallestScenarioFirstBranchingRule::branchOnFirstStage(BBSMPSNode * node, std::vector<BBSMPSNode*> &childNodes, const denseBAVector& primalSoln,  SMPSInput& input) {
...
int BBSMPSParallelPseudoCostSmallestScenarioFirstBranchingRule::getSecondStageMinIntInfeasCol( const denseBAVector& primalSoln, int scen,   SMPSInput& input) {
...
int BBSMPSParallelPseudoCostSmallestScenarioFirstBranchingRule::isSecondStageIntFeas( const denseBAVector& primalSoln, int scen, SMPSInput & input) {
return (getSecondStageMinIntInfeasCol(primalSoln, scen, input) == -1);
}

void BBSMPSParallelPseudoCostSmallestScenarioFirstBranchingRule::branchOnSecondStage(BBSMPSNode * node, std::vector<BBSMPSNode*> &childNodes,  const denseBAVector& primalSoln,  SMPSInput& input,BAContext &ctx, int mype, int scen) {
...
bool BBSMPSParallelPseudoCostSmallestScenarioFirstBranchingRule::branch(BBSMPSNode * node, std::vector<BBSMPSNode*> &childNodes,  const denseBAVector& primalSoln){
/* Branching */
...
if (!everythingSecondStageInitialized){
  ...
  //node->reconstructWarmStartState(ps);
  double lpRelaxationObjValue=node->getObjective();
  everythingSecondStageInitialized=!performRoundOfSecondStageInitializations(primalSoln,ps,lb,ub, lpRelaxationObjValue,globalComp.rank);
