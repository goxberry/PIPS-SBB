...
public:
  ...
  static BBSMPSSolver *initialize(const SMPSInput &_input, int nSolvers);
...
private:
  BBSMPSSolver(const SMPSInput &_input,MPI_Comm &pipsComm, MPI_Comm &pipsSbbComm);
  BAContext ctx; // General MPI communicator context for PIPS-S
  BAContext pipsCtx; // MPI communication context for PIPS-S
  BAContext pipsSbbCtx; // MPI communication context for PIPS-SBB
